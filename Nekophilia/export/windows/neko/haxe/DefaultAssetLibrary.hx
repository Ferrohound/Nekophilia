...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/test.csv", "assets/images/test.csv");
		type.set ("assets/images/test.csv", AssetType.TEXT);
		path.set ("assets/images/testspritesheet.png", "assets/images/testspritesheet.png");
		type.set ("assets/images/testspritesheet.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/test.csv";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/testspritesheet.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
